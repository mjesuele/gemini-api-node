...
export type TradeType = "buy" | "sell" | "auction" | "block";
...
export type AuctionStatus = { next_auction_ms: number } & (
  | AuctionPreopenStatus
  | AuctionOpenStatus
  | AuctionPriceStatus
  | AuctionFinalPriceStatus
  | AuctionClosedStatus
);
...
export type AuctionHistory = AuctionCommonHistory &
  (AuctionSuccessHistory | AuctionFailureHistory);
...
export type OrderStatus = OrderLimitStatus | OrderMarketStatus;
...
export type OrderCancelledStatus = OrderStatus & { is_cancelled: true };
